...
namespace WebApplication1.common
{
    ...
    {
        static string appkey = "9d208684186dbbd1f4d2efac99c3ccc7"; //配置您申请的appkey
        ...
        public static Weather GetWeatherByCityName(string city)
        {
            ...
            string result = sendPost(url1, parameters, "get");
        ...
        public static Weather ConverToWearther(JsonObject jsonObj)
        {
            ...
            wt.wash_index= jsonObj["result"].Object["today"].Object["wash_index"].Value;
            return wt;
        }
